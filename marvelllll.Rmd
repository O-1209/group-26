...
corrplot(corr = cor ,type='upper',order='hclust') #cor matrix
```
...
$y=\alpha+\beta_1\cdot x_{height}+\beta_2\cdot x_{weight}+\beta_3\cdot x_{intelligence}+\beta_4\cdot x_{strength}+\beta_5\cdot x_{durability}+\beta_6\cdot x_{speed}+\beta_7\cdot x_{power} $
...
$y=\alpha+ \beta_1\cdot x_{height}+\beta_2\cdot x_{intelligence}+\beta_3\cdot x_{durability}$ 
