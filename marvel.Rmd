...
Marvel Comics have created many classic characters, how to evaluate the combat effectiveness of these super heroes? This poster will display graphical and numerical summaries to the heroes characteristic data, investigating the relationship between heroes combat and their basic features.\cite{1}
...
```{r boxplot1,echo = FALSE, out.width='50%',fig.align="center", fig.cap="\\label{fig:box} Boxplot of variables"}
par(mfrow=c(1,2)) 
...
```{r starplot, echo=FALSE, out.width='80%',fig.align="center", fig.cap="\\label{fig:star} Star plot of the powerful heroes "}
#Star plot
marvel.Star <- read.csv('marvel.csv')
...
```{r visualisation, echo=FALSE, eval=TRUE, out.width='80%',fig.align="center", fig.cap= "\\label{fig:corr} Correlation plot of the corvarites "}
...
```{r confidence interval,echo=FALSE,out.width='70%',fig.align="center", fig.cap= "\\label{fig:ci} model checking plots"}
...
```{r boxplots,echo=FALSE, out.width='70%',fig.align="center",fig.cap= "\\label{fig:box2} The Combat Effectiveness of Super Heroes in Marvel by Gender"}
...
\begin{small}
\bibitem{1} https://www.kaggle.com/spatika/marvel-comics-characters-stats-and-powers/tasks
\end{small}
\end{thebibliography}
